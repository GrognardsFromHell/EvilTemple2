...
namespace EvilTemple
{
    ...
    class DagMaterial : public Material
    {
    public:
        DagMaterial();
    ...
    DagMaterial::DagMaterial() : Material("DummyMaterial")
    {
    }

    void DagMaterial::bind(QGLContext *context)
    {
        Q_UNUSED(context);
    }

    void DagMaterial::unbind(QGLContext *context)
    {
        Q_UNUSED(context);
    }
    ...
    QSharedPointer<MeshModel> DagReader::get()
    {
        // Read the DAG file
        ...
        QSharedPointer<Material> dagMaterial(new DagMaterial);
        ...
        return QSharedPointer<MeshModel>(new MeshModel(faceGroups, vertices));
    }
